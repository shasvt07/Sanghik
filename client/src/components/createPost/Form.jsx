  ...
  return (
    ...
    <Paper className="paper" elevation={6}>
      ...
      <form autoComplete="off" noValidate className="form" onSubmit={handleSubmit}>
        ...
        <input className='input' value={postData.title} placeholder='Title' onChange={(e) => setPostData({ ...postData, title: e.target.value })} /> 
        <textarea className='message' placeholder='Message' value={postData.desc} onChange={(e) => setPostData({ ...postData, desc: e.target.value })} />

            
      {/* <TextField className='input' inputProps={{}} name="title" label="Title" variant="outlined" fullWidth value={postData.title} onChange={(e) => setPostData({ ...postData, title: e.target.value })} />
      ...
      {filePerc > 0 ? (
        ...
        <div className='chips' style={{ padding: '5px 0', width: '94%' }}>
          <ChipInput
            color='primary'
            className='chipInput'
            inputStyle={styles.multilineColor}
            name="tags"
            variant="outlined"
            label="Tags"
            fullWidth
